...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.13 2014-08-10 11:06:53 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns1__magicResponse:
		if (p->size < 0)
			SOAP_DELETE((struct ns1__magicResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns1__magicResponse*)p->ptr);
		break;
	case SOAP_TYPE_ns1__magic:
		if (p->size < 0)
			SOAP_DELETE((struct ns1__magic*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns1__magic*)p->ptr);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_embedded(soap, &a->rank, SOAP_TYPE_int);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__magic(struct soap *soap, const char *tag, int id, const struct ns1__magic *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns1__magic), type))
		return soap->error;
	if (soap_out_int(soap, "rank", -1, &a->rank, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct ns1__magic * SOAP_FMAC4 soap_in_ns1__magic(struct soap *soap, const char *tag, struct ns1__magic *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns1__magic *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns1__magic, sizeof(struct ns1__magic), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_rank && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "rank", &a->rank, "xsd:int"))
				{	soap_flag_rank--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
	...
	{	a = (struct ns1__magic *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns1__magic, 0, sizeof(struct ns1__magic), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns1__magic);
	if (soap_out_ns1__magic(soap, tag?tag:"ns1:magic", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns1__magic(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns1__magic, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__magic);
		if (size)
			*size = sizeof(struct ns1__magic);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct ns1__magic, n);
		if (size)
			*size = n * sizeof(struct ns1__magic);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct ns1__magic*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns1__magic(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns1__magic %p -> %p\n", q, p));
...
SOAP_FMAC3 struct ns1__magicResponse * SOAP_FMAC4 soap_in_ns1__magicResponse(struct soap *soap, const char *tag, struct ns1__magicResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns1__magicResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns1__magicResponse, sizeof(struct ns1__magicResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns1__magicResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns1__magicResponse, 0, sizeof(struct ns1__magicResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns1__magicResponse);
	if (soap_out_ns1__magicResponse(soap, tag?tag:"ns1:magicResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns1__magicResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns1__magicResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns1__magicResponse);
		if (size)
			*size = sizeof(struct ns1__magicResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct ns1__magicResponse, n);
		if (size)
			*size = n * sizeof(struct ns1__magicResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct ns1__magicResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns1__magicResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns1__magicResponse %p -> %p\n", q, p));
