...
#define soap_write_matrix(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "SOAP-ENC:Array", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_vector(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "SOAP-ENC:Array", NULL) || soap_end_send(soap), soap->error )
#endif
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__magic(struct soap*, struct ns1__magic *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__magic(struct soap*, const struct ns1__magic *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__magic(struct soap*, const char*, int, const struct ns1__magic *, const char*);
SOAP_FMAC3 struct ns1__magic * SOAP_FMAC4 soap_in_ns1__magic(struct soap*, const char*, struct ns1__magic *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__magic(struct soap*, const struct ns1__magic *, const char*, const char*);

#ifndef soap_write_ns1__magic
#define soap_write_ns1__magic(soap, data) ( soap_begin(soap), soap_serialize_ns1__magic(soap, data), soap_begin_send(soap) || soap_put_ns1__magic(soap, data, "ns1:magic", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct ns1__magic * SOAP_FMAC4 soap_get_ns1__magic(struct soap*, struct ns1__magic *, const char*, const char*);

#ifndef soap_read_ns1__magic
#define soap_read_ns1__magic(soap, data) ( soap_begin_recv(soap) || !soap_get_ns1__magic(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct ns1__magic * SOAP_FMAC2 soap_instantiate_ns1__magic(struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__magic * soap_new_ns1__magic(struct soap *soap, int n = -1) { return soap_instantiate_ns1__magic(soap, n, NULL, NULL, NULL); }

inline struct ns1__magic * soap_new_req_ns1__magic(struct soap *soap, int rank) { struct ns1__magic *_p = soap_instantiate_ns1__magic(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns1__magic(soap, _p); _p->rank = rank; } return _p; }

inline struct ns1__magic * soap_new_set_ns1__magic(struct soap *soap, int rank) { struct ns1__magic *_p = soap_instantiate_ns1__magic(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns1__magic(soap, _p); _p->rank = rank; } return _p; }

inline void soap_delete_ns1__magic(struct soap *soap, struct ns1__magic *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns1__magic(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns1__magicResponse
#define SOAP_TYPE_ns1__magicResponse (29)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__magicResponse(struct soap*, struct ns1__magicResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__magicResponse(struct soap*, const struct ns1__magicResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__magicResponse(struct soap*, const char*, int, const struct ns1__magicResponse *, const char*);
SOAP_FMAC3 struct ns1__magicResponse * SOAP_FMAC4 soap_in_ns1__magicResponse(struct soap*, const char*, struct ns1__magicResponse *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__magicResponse(struct soap*, const struct ns1__magicResponse *, const char*, const char*);

#ifndef soap_write_ns1__magicResponse
#define soap_write_ns1__magicResponse(soap, data) ( soap_begin(soap), soap_serialize_ns1__magicResponse(soap, data), soap_begin_send(soap) || soap_put_ns1__magicResponse(soap, data, "ns1:magicResponse", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct ns1__magicResponse * SOAP_FMAC4 soap_get_ns1__magicResponse(struct soap*, struct ns1__magicResponse *, const char*, const char*);

#ifndef soap_read_ns1__magicResponse
#define soap_read_ns1__magicResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns1__magicResponse(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct ns1__magicResponse * SOAP_FMAC2 soap_instantiate_ns1__magicResponse(struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__magicResponse * soap_new_ns1__magicResponse(struct soap *soap, int n = -1) { return soap_instantiate_ns1__magicResponse(soap, n, NULL, NULL, NULL); }

inline struct ns1__magicResponse * soap_new_req_ns1__magicResponse(struct soap *soap) { struct ns1__magicResponse *_p = soap_instantiate_ns1__magicResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns1__magicResponse(soap, _p); } return _p; }

inline struct ns1__magicResponse * soap_new_set_ns1__magicResponse(struct soap *soap, matrix *result) { struct ns1__magicResponse *_p = soap_instantiate_ns1__magicResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns1__magicResponse(soap, _p); _p->result = result; } return _p; }

inline void soap_delete_ns1__magicResponse(struct soap *soap, struct ns1__magicResponse *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns1__magicResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#define SOAP_TYPE_PointerTomatrix (27)
#endif
...
#define soap_write_PointerTomatrix(soap, data) ( soap_begin(soap), soap_serialize_PointerTomatrix(soap, data), soap_begin_send(soap) || soap_put_PointerTomatrix(soap, data, "SOAP-ENC:Array", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTovector (20)
#endif
...
#define soap_write_PointerTovector(soap, data) ( soap_begin(soap), soap_serialize_PointerTovector(soap, data), soap_begin_send(soap) || soap_put_PointerTovector(soap, data, "SOAP-ENC:Array", NULL) || soap_end_send(soap), soap->error )
#endif
