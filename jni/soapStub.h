...
public:
	int soap_type() const { return 13; } /* = unique type id SOAP_TYPE_ns__Message */
};
#endif
...
{
public:
	bool ok;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* required element of type xsd:boolean */
public:
	int soap_type() const { return 14; } /* = unique type id SOAP_TYPE_ns__Confirmation */
};
#endif
...
public:
	void *_;	/* transient */
public:
	int soap_type() const { return 20; } /* = unique type id SOAP_TYPE_ns__getAvailableSensorsInfo */
};
#endif
...
public:
	void *_;	/* transient */
public:
	int soap_type() const { return 23; } /* = unique type id SOAP_TYPE_ns__getCurrentDeviceLocation */
};
#endif
...
/* ns:logMessage */
struct ns__logMessage
{
public:
	struct ns__Message *message;	/* optional element of type ns:Message */
public:
	int soap_type() const { return 27; } /* = unique type id SOAP_TYPE_ns__logMessage */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns__logMessage(struct soap*, struct ns__Message *message, struct ns__Confirmation *confirmation);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__logMessage(struct soap*);
